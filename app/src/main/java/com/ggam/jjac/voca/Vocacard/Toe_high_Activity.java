...
public class Toe_high_Activity extends BaseActivity{
    private IndexFastScrollRecyclerView mIndexView;
    private RecyclerView.LayoutManager mLayoutManager;
    private CoordinatorLayout cor_card;
    static public ArrayList<Voca> Voca_card6 = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("토익 고급");

        cor_card = (CoordinatorLayout) findViewById(R.id.cor_card);
        cor_card.setBackgroundResource(R.drawable.toeichigh_back);

        mIndexView = (IndexFastScrollRecyclerView) findViewById(R.id.index_view);
        mIndexView.setAdapter(new VocaAdapter(Voca_card6));
